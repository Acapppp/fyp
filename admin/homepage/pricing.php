    ...
    <div class="page">
          ...
          <div class="container">
            <div class="row justify-content-center">
              <div class="col-12 col-lg-9">
                <h1 class="breadcrumbs-custom-title">Pricing</h1>
      ...
      <section class="section section-xl bg-default text-center">
        <div class="container">
          ...
          <div class="row">
            <div class="col-12">
              <div class="owl-carousel" data-items="1" data-lg-items="3" data-dots="true" data-nav="false" data-stage-padding="0" data-loop="false" data-margin="0" data-mouse-drag="false">
                <div class="box-pricing-classic">
                  <h4 class="pricing-classic-title">PC Repair</h4>
                  ...
                  <h2 class="pricing-classic-price"><span>$</span>25</h2><a class="button button-primary" href="#">order</a>
                </div>
                <div class="box-pricing-classic box-pricing-selected">
                  <h4 class="pricing-classic-title">Smartphone Repair</h4>
                  <ul class="pricing-classic-list">
                    <li>Display Replacement</li>
                    <li>Battery Replacement</li>
                    <li>Camera Lens Replacement</li>
                    <li>Speaker Replacement</li>
                    <li>Charging Dock Replacement</li>
                  </ul>
                  <h2 class="pricing-classic-price"><span>$</span>45</h2><a class="button button-primary" href="#">order</a>
                </div>
                <div class="box-pricing-classic">
                  <h4 class="pricing-classic-title">Tablet Repair</h4>
                  <ul class="pricing-classic-list">
                    <li>LCD Repair</li>
                    <li>Front Glass Repair (Glass Only)</li>
                    <li>Battery Replacement</li>
                    <li>Headphone Jack Repair</li>
                    <li>Microphone Repair</li>
                  </ul>
                  <h2 class="pricing-classic-price"><span>$</span>65</h2><a class="button button-primary" href="#">order</a>
                </div>
              </div>
            </div>
          </div>
