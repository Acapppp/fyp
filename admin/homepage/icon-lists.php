...
<html class="wide wow-animation" lang="en">
  ...
  <body>
    ...
    <div class="page">
            ...
            <div class="rd-navbar-main-outer">
              <div class="rd-navbar-main">
                ...
                <div class="rd-navbar-panel">
                  ...
                  <!-- RD Navbar Brand-->
                  <div class="rd-navbar-brand"><a class="brand" href="index.html"><img src="images/logo-default-266x88.png" alt="" width="133" height="44"/></a>
                  </div>
                </div>
                <div class="rd-navbar-main-element">
                  <div class="rd-navbar-nav-wrap">
                    ...
                    <div class="rd-nav-tel">
                      <div class="icon mdi mdi-phone icon-secondary"></div><a href="tel:#">1-800-123-1234</a>
                    </div>
                  </div>
                </div>
                <div class="rd-nav-tel">
                  <div class="icon mdi mdi-phone text-primary"></div><a href="tel:#">1-800-123-1234</a>
                </div>
              </div>
            </div>
          </nav>
      ...
      <section class="parallax-container" data-parallax-img="images/bg-breadcrumbs-03.jpg">
        <div class="parallax-content breadcrumbs-custom context-dark"> 
          <div class="container">
            <div class="row justify-content-center">
              <div class="col-12 col-lg-9">
                <h1 class="breadcrumbs-custom-title">Icon Lists</h1>
          ...
          <div class="row row-lg-75 row-35">
            <div class="col-md-6 col-lg-4 wow-outer">
              <div class="wow slideInLeft">
                <div class="box-icon-classic">
                  <div class="box-icon-inner decorate-triangle"><span class="text-secondary icon-xl electro-icon-02"></span></div>
                  <div class="box-icon-caption">
                    <h4><a href="#">Laptop Repair</a></h4>
                    <p>We offer affordable repair services of all laptop brands and models to individual and corporate clients.</p>
                  </div>
                </div>
              </div>
            </div>
            <div class="col-md-6 col-lg-4 wow-outer">
              <div class="wow slideInDown">
                <div class="box-icon-classic">
                  <div class="box-icon-inner decorate-circle"><span class="text-secondary icon-xl electro-icon-04"></span></div>
                  <div class="box-icon-caption">
                    <h4><a href="#">Smartphone Repair</a></h4>
                    <p>FixIt provides smartphone repair services that include solutions even for the most complex issues.</p>
                  </div>
                </div>
              </div>
            </div>
            <div class="col-md-6 col-lg-4 wow-outer">
              <div class="wow slideInRight">
                <div class="box-icon-classic">
                  <div class="box-icon-inner decorate-rectangle"><span class="text-secondary icon-xl electro-icon-08"></span></div>
                  <div class="box-icon-caption">
                    <h4><a href="#">Computer Repair</a></h4>
                    <p>Our highly qualified team offers a wide range of PC & Mac repair services as well as free diagnostics.</p>
                  </div>
                </div>
              </div>
            </div>
      ...
      <section class="section section-lg bg-gray-1">
        <div class="container">
          <h3 class="text-center">Icon List #2</h3>
          <div class="row row-xl-85 row-sm-60 row-35">
            <div class="col-md-6 col-lg-4">
              <div class="box-icon-modern">
                <div class="box-icon-inner decorate-triangle"><span class="text-secondary icon-xl electro-icon-08"></span></div>
                <div class="box-icon-caption">
                  <h4><a href="#">Computer Repair</a></h4>
            ...
            <div class="col-md-6 col-lg-4">
              <div class="box-icon-modern">
                ...
                <div class="box-icon-caption">
                  <h4><a href="#">Smartphone Repair</a></h4>
                  <p>Ei sumo eruditi sadipscing nec, scripta epicurei ut eam. Duo ut fastidii</p>
                </div>
              </div>
            </div>
            <div class="col-md-6 col-lg-4">
              <div class="box-icon-modern">
                <div class="box-icon-inner decorate-rectangle"><span class="text-secondary icon-xl electro-icon-02"></span></div>
                <div class="box-icon-caption">
                  <h4><a href="#">Laptop Repair</a></h4>
                  <p>Vel nihil percipitur ei. Fugit option oportere est in, te dignissim phil</p>
                </div>
              </div>
            </div>
            <div class="col-md-6 col-lg-4">
              <div class="box-icon-modern">
                <div class="box-icon-inner decorate-circle"><span class="text-secondary icon-xxl electro-icon-11"></span></div>
                <div class="box-icon-caption">
                  <h4><a href="#">Media Player Repair</a></h4>
                  <p>Te partem omnesque eligendi has, nam ex persius lobortis. His ex amet fa</p>
                </div>
              </div>
            </div>
            <div class="col-md-6 col-lg-4">
              <div class="box-icon-modern">
                <div class="box-icon-inner decorate-triangle"><span class="text-secondary icon-xl electro-icon-05"></span></div>
                <div class="box-icon-caption">
                  <h4><a href="#">Smartwatch Repair</a></h4>
                  <p>Ei tollit euismod cum, augue labore euripidis mel ex, ut corpora appella</p>
                </div>
              </div>
            </div>
            <div class="col-md-6 col-lg-4">
              <div class="box-icon-modern">
                <div class="box-icon-inner decorate-rectangle"><span class="text-secondary icon-xxl electro-icon-13"></span></div>
                <div class="box-icon-caption">
                  <h4><a href="#">Game Console Repair</a></h4>
                  <p>Tollit fuisset mei ea, has no omnium accumsan, exerci dolorem praesent</p>
                </div>
              </div>
            </div>
          </div>
                ...
                <div class="row row-35 justify-content-between">
                  ...
                  <div class="col-md-6">
                    ...
                    <ul class="list-contact-info">
                      <li><span class="icon mdi mdi-map-marker icon-md icon-primary"></span><span class="list-item-text"><a href="#">51 Francis Street, Darlinghurst NSW 2010, United States</a></span></li>
            ...
            <div class="col-lg-4 order-lg-1 wow-outer pr-xl-100">
              <div class="wow slideInLeft">
                <div class="row row-37">
                  <div class="col-12"><a class="brand" href="index.html"><img src="images/logo-default-266x88.png" alt="" width="133" height="44"/></a>
                  </div>
                  <div class="col-12">
                    <p>FixIt was founded by an experienced team of technicians who know how to get any modern PC or gadget working the right way. With over 20 years of expertise, you can always trust us.</p>
                    <div class="footer-divider"></div>
                    <p class="rights"><span>&copy;&nbsp;</span><span class="copyright-year"></span><span>&nbsp;</span><span>Fixit</span><span>.&nbsp;</span><span>All Rights Reserved.</span><br/><a href="privacy-policy.html">Privacy Policy.</a></p>
                  </div>
                </div>
              </div>
            </div>
