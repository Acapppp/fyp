...
$count_query = "SELECT COUNT(*) AS total_customers FROM custinfo WHERE staff_ic = '$staffIC'";
...
if (isset($_POST['btnsearch'])) {
    ...
    $sqlsearch = "SELECT * FROM custinfo WHERE custic LIKE '$search%' AND staff_ic = '$staffIC'";
